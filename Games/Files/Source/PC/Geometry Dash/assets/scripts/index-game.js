...
if (window.useCustomPlayerIcon == null) {
  try {
    window.useCustomPlayerIcon = localStorage.getItem("useCustomPlayerIcon") === "1";
  } catch (_0x36d727) {
    window.useCustomPlayerIcon = false;
  }
}
if (!Array.isArray(window.customIconList)) {
  window.customIconList = [];
}
if (window.customPlayerTextureKey == null) {
  try {
    window.customPlayerTextureKey = localStorage.getItem("customPlayerTextureKey") || "custom.png";
  } catch (_0x27857f) {
    window.customPlayerTextureKey = "custom.png";
  }
}
if (window.customPlayerIconName == null) {
  try {
    window.customPlayerIconName = localStorage.getItem("customPlayerIconName") || "Custom";
  } catch (_0x4e9062) {
    window.customPlayerIconName = "Custom";
  }
}
window.currentlevel = [
...
preload() {
    ...
    this.load.json("customIconConfig", "custom.json");
  ...
  create() {
    ...
    const _0x4e9038 = this.cache.json.get("customIconConfig");
    const _0x59d10d = [];
    if (Array.isArray(_0x4e9038)) {
      for (let _0x40e81e = 0; _0x40e81e < _0x4e9038.length; _0x40e81e++) {
        const _0x2f1c16 = _0x4e9038[_0x40e81e] || {};
        const _0x39410b = (_0x2f1c16.name || `Icon ${_0x40e81e + 1}`).toString();
        const _0x39ea1f = (_0x2f1c16.icon || "").toString().trim();
        if (!_0x39ea1f) {
          continue;
        }
        const _0x2d2e2e = _0x39ea1f.replace(/^\.\//, "");
        const _0x2a8ccf = `custom_icon_${_0x40e81e}`;
        _0x59d10d.push({
          name: _0x39410b,
          key: _0x2a8ccf,
          path: _0x2d2e2e
        });
        if (!this.textures.exists(_0x2a8ccf)) {
          this.load.image(_0x2a8ccf, _0x2d2e2e);
        }
      }
    }
    if (!this.textures.exists("custom.png")) {
      this.load.image("custom.png", "assets/custom.png");
    }
    const _0x58f810 = this.textures.exists("custom.png");
    window.customIconList = [..._0x59d10d];
    if (_0x58f810) {
      window.customIconList.unshift({
        name: "Custom",
        key: "custom.png",
        path: "assets/custom.png"
      });
    }
    const _0x307848 = window.customIconList.some(_0x45a81f => _0x45a81f.key === window.customPlayerTextureKey);
    if (!_0x307848 && window.customIconList.length > 0) {
      window.customPlayerTextureKey = window.customIconList[0].key;
      window.customPlayerIconName = window.customIconList[0].name;
      try {
        localStorage.setItem("customPlayerTextureKey", window.customPlayerTextureKey);
        localStorage.setItem("customPlayerIconName", window.customPlayerIconName);
      } catch (_0x2f9030) {}
    }
...
function ds(scene, _0x592bc1, _0x4d69dc, _0xfb965c, _0x43d3fd, _0x5bbdf1) {
  ...
  let _0x38da45 = null;
  if (_0x221d10) {
    _0x38da45 = scene.add.image(_0x592bc1, _0x4d69dc, _0x221d10.atlas, _0x221d10.frame);
  } else if (scene.textures.exists(_0xfb965c)) {
    _0x38da45 = scene.add.image(_0x592bc1, _0x4d69dc, _0xfb965c);
  } else {
    return null;
  }
...
function getCustomCubeTextureKey(scene) {
  const _0x11c823 = (window.customPlayerTextureKey || "custom.png").toString();
  if (scene && scene.textures && scene.textures.exists(_0x11c823)) {
    return _0x11c823;
  }
  return "custom.png";
}
class ps {
  ...
  _createSprites() {
    ...
    const _0x4d2909 = window.useCustomPlayerIcon ? getCustomCubeTextureKey(_0x1872a7) : `${window.currentPlayer}_001.png`;
    this._playerSpriteLayer = ds(_0x1872a7, _0xf42f36, _0x28689a, _0x4d2909, 10, true);
    ...
    this._useCustomCubeIcon = false;
    this.setCustomCubeIconEnabled(!!window.useCustomPlayerIcon);
  ...
  setCustomCubeIconEnabled(_0x346cb6) {
    const _0x2f3a43 = getCustomCubeTextureKey(this._scene);
    const _0x52d958 = !!_0x346cb6 && this._scene.textures.exists(_0x2f3a43);
    this._useCustomCubeIcon = _0x52d958;
    if (!this._playerSpriteLayer || !this._playerSpriteLayer.sprite) {
      return;
    }
    const _0x1ca4e7 = this._playerSpriteLayer.sprite;
    if (_0x52d958) {
      _0x1ca4e7.setTexture(_0x2f3a43);
      _0x1ca4e7.clearTint();
      _0x1ca4e7.setScale(1);
    } else {
      const _0x2fdfdb = `${window.currentPlayer}_001.png`;
      const _0xc618b7 = R(this._scene, _0x2fdfdb);
      if (_0xc618b7) {
        _0x1ca4e7.setTexture(_0xc618b7.atlas, _0xc618b7.frame);
      }
      _0x1ca4e7.setTint(window.mainColor);
      _0x1ca4e7.setScale(1);
    }
    this.setCubeVisible(_0x1ca4e7.visible);
  }
  ...
  setCubeVisible(_0x411813) {
    ...
    const _0x46298b = !!this._useCustomCubeIcon;
    if (this._playerGlowLayer) {
      this._playerGlowLayer.sprite.setVisible(_0x411813 && !_0x46298b && this._playerGlowLayer.sprite._glowEnabled);
    }
    if (this._playerOverlayLayer) {
      this._playerOverlayLayer.sprite.setVisible(_0x411813 && !_0x46298b);
    }
    if (this._playerExtraLayer) {
      this._playerExtraLayer.sprite.setVisible(_0x411813 && !_0x46298b);
    }
  }
...
class xs extends Phaser.Scene {
  ...
  create() {
    ...
    this._makeBouncyButton(this._menuInfoBtn, 0.64, () => {
      this._closeCustomIconPopup();
      this._buildInfoPopup();
    }, () => this._menuActive && !this._infoPopup);
    this._customIconToggleBg = this.add.rectangle(screenWidth - 130, 76, 160, 28, 0x3b1e2b, 0.88).setScrollFactor(0).setDepth(30).setStrokeStyle(2, 0xff7aa0, 0.95).setInteractive();
    this._customIconToggleLabel = this.add.text(screenWidth - 130, 76, "", {
      fontSize: "13px",
      color: "#ffe0ea",
      fontFamily: "Arial"
    }).setOrigin(0.5, 0.5).setScrollFactor(0).setDepth(31);
    this._makeBouncyButton(this._customIconToggleBg, 1, () => {
      this._toggleCustomIconMode();
    }, () => this._menuActive && !this._infoPopup);
    this._customIconHint = this.add.bitmapText(screenWidth - 130, 100, "goldFont", "click C", 28).setOrigin(0.5, 0.5).setScrollFactor(0).setDepth(31).setScale(0.6);
    this._refreshCustomIconToggle();
    ...
    this._cKey.on("down", () => {
      if (!this._menuActive || !window.useCustomPlayerIcon || this._infoPopup) {
        return;
      }
      if (this._customIconPopup) {
        this._closeCustomIconPopup();
      } else {
        this._buildCustomIconPopup();
      }
    });
  ...
  _buildInfoPopup() {
    ...
    yPos += 70;
    const _0x22e4c7 = this.add.bitmapText(xPos, yPos, "goldFont", "Made by RobTop Games Upgraded by Glitch", 40).setOrigin(0.5, 0.5).setScale(0.6);
  ...
  _buildCustomIconPopup() {
    if (this._customIconPopup) {
      return;
    }
    const _0x57f7bb = this.add.container(0, 0).setScrollFactor(0).setDepth(95);
    this._customIconPopup = _0x57f7bb;
    const _0x254efd = Math.min(560, screenWidth - 80);
    const _0x55d2bd = Math.min(430, screenHeight - 100);
    const _0x39db90 = screenWidth / 2;
    const _0x4f58f3 = screenHeight / 2;
    const _0x3cd9ac = this.add.rectangle(_0x39db90, _0x4f58f3, _0x254efd, _0x55d2bd, 0x121231, 0.95).setStrokeStyle(4, 0x5db2ff, 1);
    _0x57f7bb.add(_0x3cd9ac);
    const _0x10fd65 = this.add.bitmapText(_0x39db90, _0x4f58f3 - _0x55d2bd / 2 + 32, "bigFont", "CUSTOM ICONS", 42).setOrigin(0.5, 0.5).setScale(0.75);
    _0x57f7bb.add(_0x10fd65);
    const _0x5c0e1a = this.add.bitmapText(_0x39db90, _0x4f58f3 - _0x55d2bd / 2 + 64, "goldFont", "select one", 34).setOrigin(0.5, 0.5).setScale(0.5);
    _0x57f7bb.add(_0x5c0e1a);
    const _0x334edb = this.add.image(_0x39db90 + _0x254efd / 2 - 28, _0x4f58f3 - _0x55d2bd / 2 + 28, "GJ_WebSheet", "GJ_closeBtn_001.png").setScale(0.55).setInteractive();
    this._expandHitArea(_0x334edb, 1.6);
    this._makeBouncyButton(_0x334edb, 0.55, () => this._closeCustomIconPopup());
    _0x57f7bb.add(_0x334edb);
    const _0x6be628 = Array.isArray(window.customIconList) ? window.customIconList : [];
    const _0x3ef57f = Math.min(_0x6be628.length, 7);
    if (_0x3ef57f === 0) {
      const _0x3f6255 = this.add.bitmapText(_0x39db90, _0x4f58f3, "goldFont", "No icons found in custom.json", 36).setOrigin(0.5, 0.5).setScale(0.55);
      _0x57f7bb.add(_0x3f6255);
      return;
    }
    const _0x30ca59 = _0x4f58f3 - _0x55d2bd / 2 + 108;
    for (let _0x4a6f20 = 0; _0x4a6f20 < _0x3ef57f; _0x4a6f20++) {
      const _0x59863b = _0x6be628[_0x4a6f20];
      const _0x4dc18d = _0x30ca59 + _0x4a6f20 * 42;
      const _0x24c6f8 = _0x59863b.key === window.customPlayerTextureKey;
      const _0x21c03f = this.add.rectangle(_0x39db90, _0x4dc18d, _0x254efd - 44, 34, _0x24c6f8 ? 0x1f6c42 : 0x1b1b40, 0.92).setStrokeStyle(2, _0x24c6f8 ? 0x78ffc0 : 0x6ea7ff, 0.95).setInteractive();
      const _0x24edf8 = this.add.bitmapText(_0x39db90 - _0x254efd / 2 + 54, _0x4dc18d, "goldFont", _0x59863b.name || `Icon ${_0x4a6f20 + 1}`, 30).setOrigin(0, 0.5).setScale(0.55);
      _0x57f7bb.add(_0x21c03f);
      _0x57f7bb.add(_0x24edf8);
      if (this.textures.exists(_0x59863b.key)) {
        const _0x4f09f2 = this.add.image(_0x39db90 + _0x254efd / 2 - 46, _0x4dc18d, _0x59863b.key).setScale(0.42);
        _0x57f7bb.add(_0x4f09f2);
      }
      this._makeBouncyButton(_0x21c03f, 1, () => {
        window.customPlayerTextureKey = _0x59863b.key;
        window.customPlayerIconName = _0x59863b.name || "Custom";
        try {
          localStorage.setItem("customPlayerTextureKey", window.customPlayerTextureKey);
          localStorage.setItem("customPlayerIconName", window.customPlayerIconName);
        } catch (_0x35d7e0) {}
        if (this._player && this._player.setCustomCubeIconEnabled) {
          this._player.setCustomCubeIconEnabled(window.useCustomPlayerIcon);
        }
        this._closeCustomIconPopup();
      });
    }
    if (_0x6be628.length > _0x3ef57f) {
      const _0x22b962 = this.add.bitmapText(_0x39db90, _0x4f58f3 + _0x55d2bd / 2 - 24, "goldFont", `Showing ${_0x3ef57f}/${_0x6be628.length}`, 26).setOrigin(0.5, 0.5).setScale(0.5);
      _0x57f7bb.add(_0x22b962);
    }
  }
  _closeCustomIconPopup() {
    if (this._customIconPopup) {
      this._customIconPopup.destroy();
      this._customIconPopup = null;
    }
  }
  _refreshCustomIconToggle() {
    if (!this._customIconToggleBg || !this._customIconToggleLabel) {
      return;
    }
    const _0x550f8b = !!window.useCustomPlayerIcon;
    if (_0x550f8b) {
      this._customIconToggleBg.setFillStyle(0x1e6b3f, 0.88);
      this._customIconToggleBg.setStrokeStyle(2, 0x6dffb5, 0.95);
      this._customIconToggleLabel.setColor("#d5ffe9");
      this._customIconToggleLabel.setText("???: ON");
    } else {
      this._customIconToggleBg.setFillStyle(0x3b1e2b, 0.88);
      this._customIconToggleBg.setStrokeStyle(2, 0xff7aa0, 0.95);
      this._customIconToggleLabel.setColor("#ffe0ea");
      this._customIconToggleLabel.setText("???: OFF");
    }
    this._customIconToggleLabel.setPosition(this._customIconToggleBg.x, this._customIconToggleBg.y);
    if (this._customIconHint) {
      this._customIconHint.setVisible(!!window.useCustomPlayerIcon);
    }
  }
  _toggleCustomIconMode() {
    window.useCustomPlayerIcon = !window.useCustomPlayerIcon;
    try {
      localStorage.setItem("useCustomPlayerIcon", window.useCustomPlayerIcon ? "1" : "0");
    } catch (_0x36a326) {}
    this._refreshCustomIconToggle();
    if (this._player && this._player.setCustomCubeIconEnabled) {
      this._player.setCustomCubeIconEnabled(window.useCustomPlayerIcon);
  ...
  _startGame() {
    ...
    if (this._customIconToggleBg) {
      this.tweens.add({
        targets: this._customIconToggleBg,
        y: -this._customIconToggleBg.height,
        duration: 300,
        ease: "Quad.In",
        onComplete: () => {
          this._customIconToggleBg.destroy();
          this._customIconToggleBg = null;
        }
      });
    }
    if (this._customIconToggleLabel) {
      this.tweens.add({
        targets: this._customIconToggleLabel,
        y: -40,
        duration: 300,
        ease: "Quad.In",
        onComplete: () => {
          this._customIconToggleLabel.destroy();
          this._customIconToggleLabel = null;
        }
      });
    }
    if (this._customIconHint) {
      this.tweens.add({
        targets: this._customIconHint,
        y: -40,
        duration: 300,
        ease: "Quad.In",
        onComplete: () => {
          this._customIconHint.destroy();
          this._customIconHint = null;
        }
      });
    }
  ...
  _positionMenuItems() {
    ...
    if (this._customIconToggleBg) {
      this._customIconToggleBg.x = screenWidth - 130;
      this._customIconToggleBg.y = 76;
    }
    if (this._customIconToggleLabel) {
      this._customIconToggleLabel.x = screenWidth - 130;
      this._customIconToggleLabel.y = 76;
    }
    if (this._customIconHint) {
      this._customIconHint.x = screenWidth - 130;
      this._customIconHint.y = 100;
    }
    if (this._copyrightText) {
